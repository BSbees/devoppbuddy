...
public class PasswordResetTokenIntegrationTest extends AbstractIntegrationTest {
    ...
    public void testDeleteToken() throws Exception {
        ...
        PasswordResetToken emptyToken = passwordResetTokenRepository.findOne(tokenId);
        Assert.assertNull(emptyToken);
    }
    ...
    public void testCascadeDeleteFromUserEntity() throws Exception {
        ...
        Set<PasswordResetToken> emptyTokens = passwordResetTokenRepository.findAllByUserId(user.getId());
    ...
    public void testMultipleTokensAreReturnedWhenQueringByUserId() throws Exception{
        ...
        User foundedUser = userRepository.findOne(user.getId());

        Set<PasswordResetToken> actualTokens = passwordResetTokenRepository.findAllByUserId(foundedUser.getId());
